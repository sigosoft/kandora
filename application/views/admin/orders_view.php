              ...
              <div class="col-12">
                <div class="page-title-box">
                  ...
                  <ol class="breadcrumb float-right">
                    <a target="_blank" href="<?=site_url("orders/showInvoice/".$invoice->invoice_id)?>" class="btn btn-gradient btn-rounded waves-light waves-effect w-md">Print invoice</a>
                  </ol>
                            ...
                            <tbody>
                              ...
                              <?php if ($invoice->status == 'order') { ?>
                                <tr>
                                  <td>Change status</td>
                                  <td>
                                    <form action="<?=site_url('orders/change_status')?>" method="post">
